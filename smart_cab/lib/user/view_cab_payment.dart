...
class ViewReply extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const ViewCabPayment(title: ''),
    );
  }
}

class ViewCabPayment extends StatefulWidget {
  const ViewCabPayment({super.key, required this.title});

  final String title;

  @override
  State<ViewCabPayment> createState() => _ViewCabPaymentState();
}

class _ViewCabPaymentState extends State<ViewCabPayment> {
  _ViewCabPaymentState() {
    viewreply();
  }
  ...
  Future<void> viewreply() async {
    ...
    try {
      ...
      String url = '$urls/user_view_cab_payment/';
