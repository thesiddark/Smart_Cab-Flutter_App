...
class ptemp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const UserViewRequestStatusMore(title: 'Home'),
    );
  }
}

class UserViewRequestStatusMore extends StatefulWidget {
  const UserViewRequestStatusMore({super.key, required this.title});

  final String title;

  @override
  State<UserViewRequestStatusMore> createState() => _UserViewRequestStatusMoreState();
}
...
class _UserViewRequestStatusMoreState extends State<UserViewRequestStatusMore> {
  ...
  void senddata() async {
    ...
    final urls = Uri.parse('$url/user_view_request_status_more/');
    try {
  ...
  _UserViewRequestStatusMoreState() {
    senddata();
  }
