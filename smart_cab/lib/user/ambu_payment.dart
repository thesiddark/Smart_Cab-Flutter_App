...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      home: AmbulancePayment(),
    );
  }
}

class AmbulancePayment extends StatefulWidget {
  @override
  _AmbulancePaymentState createState() => _AmbulancePaymentState();
}

class _AmbulancePaymentState extends State<AmbulancePayment> {
            ...
            child: Column(
              children: [
                ...
                TextFormField(
                  ...
                  controller:payController,decoration: InputDecoration(border: OutlineInputBorder(borderRadius: BorderRadius.circular(20)),prefixIcon: Icon(Icons.currency_rupee)),),
                SizedBox(height: 20,),
                ElevatedButton(
                  onPressed: () {
  ...
  void senddata()async {
    ...
    String rid=sh.getString('aid').toString();

    final urls = Uri.parse('$url/user_send_ambu_payment/');
    try {
