...
class ptemp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const UserViewAmbulancemore(title: 'Home'),
    );
  }
}

class UserViewAmbulancemore extends StatefulWidget {
  const UserViewAmbulancemore({super.key, required this.title});

  final String title;

  @override
  State<UserViewAmbulancemore> createState() => _UserViewAmbulancemoreState();
}
class _UserViewAmbulancemoreState extends State<UserViewAmbulancemore> {
  ...
  void senddata() async {
    ...
    final urls = Uri.parse('$url/user_view_ambulance_more/');
    try {
