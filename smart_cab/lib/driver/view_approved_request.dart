...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const UserApprovedStatus(title: ''),
    );
  }
}

class UserApprovedStatus extends StatefulWidget {
  const UserApprovedStatus({super.key, required this.title});

  final String title;

  @override
  State<UserApprovedStatus> createState() => _UserApprovedStatusState();
}

class _UserApprovedStatusState extends State<UserApprovedStatus> {
  _UserApprovedStatusState() {
    viewmanager();
  }
  ...
  Future<void> viewmanager() async {
    ...
    try {
      ...
      String url = '$urls/driver_view_approved_request/';
                        ...
                        child: IconButton(
                          ...
                          onPressed: () async {
                            SharedPreferences sh = await SharedPreferences
                                .getInstance();
                            String mid = ulid_[index].toString();
                            String url = sh.getString('url').toString();
                            final urls = Uri.parse(
                                '$url/driver_get_user_location/');
                            try {
