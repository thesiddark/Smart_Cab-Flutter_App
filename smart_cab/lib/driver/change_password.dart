...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const Driver_Change_Password(title: 'Review and Rating'),
    );
  }
}

class Driver_Change_Password extends StatefulWidget {
  const Driver_Change_Password({super.key, required this.title});

  final String title;

  @override
  State<Driver_Change_Password> createState() => _Driver_Change_PasswordState();
}

class _Driver_Change_PasswordState extends State<Driver_Change_Password> {
  // String _rating = "";
  ...
  Widget build(BuildContext context) {
    return WillPopScope(   onWillPop: () async {
      ...
      return false;
        ...
        child: Scaffold(
      appBar: AppBar(
        // Here we take the value from the Driver_Change_Password object that was created by
