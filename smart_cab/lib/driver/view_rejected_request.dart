...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const UserRejectedStatus(title: ''),
    );
  }
}

class UserRejectedStatus extends StatefulWidget {
  const UserRejectedStatus({super.key, required this.title});

  final String title;

  @override
  State<UserRejectedStatus> createState() => _UserRejectedStatusState();
}

class _UserRejectedStatusState extends State<UserRejectedStatus> {
  _UserRejectedStatusState() {
    viewmanager();
  }
  ...
  Future<void> viewmanager() async {
    ...
    try {
      ...
      String url = '$urls/driver_view_rejected_request/';
