...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MySignPage(title: 'SIGNUP'),
    );
  }
}

class MySignPage extends StatefulWidget {
  const MySignPage({super.key, required this.title});
...
class _MySignPageState extends State<MySignPage> {
  ...
  void senddata() async {
    ...
    final urls = Uri.parse('$url/driver_signup_post/');
    try {
