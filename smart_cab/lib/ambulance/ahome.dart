...
import 'package:smart_cab/ambulance/change_password.dart';
import 'package:smart_cab/ambulance/view_approved_request.dart';
import 'package:smart_cab/ambulance/view_profile.dart';
import 'package:smart_cab/ambulance/view_rejected_request.dart';
import 'package:smart_cab/ambulance/view_request.dart';
import 'package:smart_cab/ambulance/view_user_payment.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const AmbulanceHome(title: ''),
    );
  }
}

class AmbulanceHome extends StatefulWidget {
  const AmbulanceHome({super.key, required this.title});
          ...
          Container(
            ...
            child: GridView(
              ...
              children: [
                    ...
                    child:  Column(
                        children: [
                          ...
                          InkWell(
                            ...
                            onTap: () {
                              Navigator.push(context, MaterialPageRoute(
                                builder: (context) => Ambulance_Profile(title: ""),));
                            },
                          ),
                    ...
                    child:  Column(
                        children: [
                          ...
                          InkWell(
                            ...
                            onTap: () {
                              Navigator.push(context, MaterialPageRoute(
                                builder: (context) => AmbulanceRequestStatus(title:""),));
                            },
                          ),
                          SizedBox(height: 10.0),
                          // CircleAvatar(radius: 50,backgroundImage: NetworkImage(photo_[index])),
                    ...
                    child:  Column(
                        children: [
                          ...
                          InkWell(
                            ...
                            onTap: () {
                              Navigator.push(context, MaterialPageRoute(
                                builder: (context) => AmbulanceApprovedStatus(title:""),));
                            },
                          ),
                          SizedBox(height: 10.0),
                          // CircleAvatar(radius: 50,backgroundImage: NetworkImage(photo_[index])),
                    ...
                    child:  Column(
                        children: [
                          ...
                          InkWell(
                            ...
                            onTap: () {
                              Navigator.push(context, MaterialPageRoute(
                                builder: (context) => AmbulanceRejectedStatus(title:""),));
                            },
                          ),
                          SizedBox(height: 10.0),
                          // CircleAvatar(radius: 50,backgroundImage: NetworkImage(photo_[index])),
                    ...
                    child:  Column(
                        children: [
                          ...
                          InkWell(
                            ...
                            onTap: () {
                              Navigator.push(context, MaterialPageRoute(
                                builder: (context) => AmbulanceViewUserPayment(title:""),));
                            },
                          ),
                          SizedBox(height: 10.0),
                          // CircleAvatar(radius: 50,backgroundImage: NetworkImage(photo_[index])),
                ...
                //             onTap: () {
                //               // Navigator.push(context, MaterialPageRoute(
                //               // builder: (context) => ViewOwnMissingObject(title:""),));
                //             },
                //           ),
                //           SizedBox(height: 10.0),
                //           // CircleAvatar(radius: 50,backgroundImage: NetworkImage(photo_[index])),
                ...
                //               Padding(
                //                 padding: EdgeInsets.all(1),
                //                 child: Text("Objects",style: TextStyle(color: Colors.white,fontSize: 18,    fontWeight: FontWeight.bold,
                //                 )),
                //               ),],
                //           ),
                //
              ...
              children: [
                DrawerHeader(
                  ...
                  Column(children: [
                    ...
                    CircleAvatar(radius: 50,backgroundImage: AssetImage('assets/Ambulance_yellow.png')),
                ...
                ListTile(
                  ...
                  onTap: () {
                    ...
                    Navigator.push(context, MaterialPageRoute(builder: (context) => AmbulanceHome(title: "",),));
                  },
                ),
                ListTile(
                  ...
                  onTap: () {
                    Navigator.pop(context);
                    Navigator.push(context, MaterialPageRoute(builder: (context) => Ambulance_Profile(title: ''),));
                  },
                ),
                ListTile(
                  ...
                  onTap: () {
                    Navigator.pop(context);
                    Navigator.push(context, MaterialPageRoute(builder: (context) => AmbulanceRequestStatus(title: "",),));
                  },
                ),
                ListTile(
                  ...
                  onTap: () {
                    Navigator.pop(context);
                    Navigator.push(context, MaterialPageRoute(builder: (context) => AmbulanceApprovedStatus(title: " ",),));
                  },
                ),
                ListTile(
                  ...
                  onTap: () {
                    Navigator.pop(context);
                    Navigator.push(context, MaterialPageRoute(builder: (context) => AmbulanceRejectedStatus(title: ""),));
                  },
                ),
                ListTile(
                  ...
                  onTap: () {
                    Navigator.pop(context);
                    Navigator.push(context, MaterialPageRoute(builder: (context) => Ambulance_Change_Password(title: "Test Details",),));
                  },
                ),
                ...
                //   onTap: () {
                //     // Navigator.pop(context);
                //     // Navigator.push(context, MaterialPageRoute(builder: (context) => AmbulanceHome(title: 'View Worker',),));
                //   },
                // ),
                ListTile(
