...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const AmbulanceRejectedStatus(title: ''),
    );
  }
}

class AmbulanceRejectedStatus extends StatefulWidget {
  const AmbulanceRejectedStatus({super.key, required this.title});

  final String title;

  @override
  State<AmbulanceRejectedStatus> createState() => _AmbulanceRejectedStatusState();
}

class _AmbulanceRejectedStatusState extends State<AmbulanceRejectedStatus> {
  _AmbulanceRejectedStatusState() {
    viewmanager();
  }
  ...
  Future<void> viewmanager() async {
    ...
    try {
      ...
      String url = '$urls/ambulance_view_rejected_request/';
