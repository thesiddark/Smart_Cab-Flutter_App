...
class ViewReply extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const AmbulanceViewUserPayment(title: ''),
    );
  }
}

class AmbulanceViewUserPayment extends StatefulWidget {
  const AmbulanceViewUserPayment({super.key, required this.title});

  final String title;

  @override
  State<AmbulanceViewUserPayment> createState() => _AmbulanceViewUserPaymentState();
}

class _AmbulanceViewUserPaymentState extends State<AmbulanceViewUserPayment> {
  _AmbulanceViewUserPaymentState() {
    viewreply();
  }
  ...
  Future<void> viewreply() async {
    ...
    try {
      ...
      String url = '$urls/ambulance_view_user_payment/';
